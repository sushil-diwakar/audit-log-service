...
class DevSecurityConfigTest {
    ...
    void requestWithValidAuth_Returns200() throws Exception {
        mockMvc.perform(get("/audit/events").with(httpBasic("test", "test")))
