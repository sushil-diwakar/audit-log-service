...
@SpringBootTest(properties = {
    "DEV_USER=test", "DEV_PASSWORD=test", "audit.redaction.hmac-secret=test-secret", "DB_URL=jdbc:mysql://localhost:3306/auditdb?useSSL=false&serverTimezone=UTC&allowPublicKeyRetrieval=true", "DB_USERNAME=root", "DB_PASSWORD=root",
